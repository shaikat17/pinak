...
const AboutUs = () => {
  return (
    <div className="px-10">
      ...
      <div className="modal">
        <div className="modal-box">
          <div className="border-b border-orange-500">
            <img src="https://images.pexels.com/photos/3771807/pexels-photo-3771807.jpeg?auto=compress&cs=tinysrgb&w=400" alt="Founder" />
            <h1 className="font-medium text-xl mt-3">John Doe</h1>
            <p>Founder - XYZ Private Limited</p>
          </div>
          {/* <hr className="text-orange-500" /> */}
          <p className="py-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere nobis nam possimus animi praesentium blanditiis beatae, exercitationem odit hic cum pariatur dolorum at excepturi accusantium mollitia optio aliquid nulla repellendus cumque magnam aut, quod repudiandae ea laboriosam. Nobis, esse voluptatum.</p>
          <p className="py-4">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quam laboriosam et labore blanditiis magni atque nihil, rerum sed reprehenderit esse.</p>
          <p className="py-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium ipsam asperiores reprehenderit officia recusandae at? Recusandae voluptatum porro inventore! Eos hic ab dolorum mollitia delectus corrupti, unde deserunt voluptatum consequatur cum molestias optio nihil voluptates aperiam obcaecati repudiandae ea, sapiente voluptate aut ratione praesentium culpa dolor, commodi esse! Sapiente, dolorem.</p>
          <p className="py-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis, non itaque modi esse repellat mollitia, ut molestias ipsam eius nisi eum perferendis accusamus magni ad quaerat nostrum officiis necessitatibus deserunt!</p>
          <p className="py-4">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Placeat, quas!</p>
      ...
      <div className="flex items-center gap-10 flex-col sm:flex-row mb-10">
        <div className="w-full sm:w-2/5">
          <img src="https://images.pexels.com/photos/3771807/pexels-photo-3771807.jpeg?auto=compress&cs=tinysrgb&w=400" alt="mission" />
        </div>
        <div className="w-full sm:w-3/5">
          ...
          <label htmlFor="my_modal_6" className="bg-orange-500 mt-10 p-2 rounded text-white">
