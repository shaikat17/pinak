...
const ContactUs = () => {
  return (
    ...
    <Helmet>
        <title>Pinak Idea Private Ltd. || Contact Us</title>
      </Helmet>
    <div className="max-w-screen-xl my-10 lg:my-20 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-28 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
      <div className="flex flex-col justify-between">
        <div>
          ...
          <div className="text-gray-700 mt-8">
            ...
            <Link className="border-b-2 border-gray-400 font-bold text-blue-500"
              to="javascript:void(0)"
              onClick={() => (window.location = "mailto:test@mail.com")}
            >
              email
            </Link>{" "}
            instead.
      ...
      <div className="">
        <div>
          ...
          <input
            className="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-blue-500 focus:shadow-outline"
            type="text"
            placeholder=""
          />
        </div>
        ...
        <div className="mt-8">
          ...
          <textarea className="w-full h-32 bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-blue-500 focus:shadow-outline"></textarea>
        </div>
        <div className="mt-8">
